 ...
 */
export function imageDisplaySize(style, attrs, naturalW, naturalH, containingW) {
...
function parseMaxWidth(raw, ref) {
    if (raw == null)
        return null;
    const t = raw.trim().toLowerCase();
    if (t === '' || t === 'none')
...
function toPxSimple(value, unit) {
...
export function targetDpiSize(naturalPx, dpi, maxDpi) {
