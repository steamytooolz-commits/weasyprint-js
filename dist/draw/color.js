...
function hueToDeg(tok) {
    ...
    if (u === 'grad')
        return ((((n * 0.9) % 360) + 360) % 360);
    if (u === 'rad')
        return ((((n * 180) / Math.PI % 360) + 360) % 360);
